...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "PWA para automação de Guias de Transporte: PDF → Checklist → WhatsApp → Mobile." },
      ...
      { property: "og:description", content: "PWA para automação de Guias de Transporte: PDF → Checklist → WhatsApp → Mobile." },
